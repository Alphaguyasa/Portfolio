  ...
  return (
    <div className="flex flex-col w-full max-w-md">
              ...
              <div className="relative flex items-center gap-4">
                <div
                  className={cn(
                    ...
                    hoveredIndex === index ? "bg-[#C3E41D] scale-y-100 opacity-100" : "bg-border scale-y-50 opacity-0",
                  )}
                />
                ...
                <div className="relative w-24 h-1 rounded-full overflow-hidden bg-border/50 dark:bg-border/30">
                  ...
                  <div
                    className={cn(
                      ...
                      "bg-gradient-to-r from-[#C3E41D]/80 to-[#C3E41D]",
                    )}
                    style={{
      ...
      <div className="flex items-center gap-3 mt-10 pt-6 border-t border-border/30 dark:border-border/20">
        <div className="w-1.5 h-1.5 rounded-full bg-[#C3E41D]/60 animate-pulse" />
